    ...
    children: [
      {
        ...
        meta: { title: '公共算法/服务管理', icon: 'form' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        name: 'Controluser',
        component: () => import('@/views/controluser/index'),
        meta: { title: '用户管理', icon: '用户', roles: ['admin'] }
      }
    ]
  },
  {
