  ...
  <div class="userWrapper">
    ...
    >
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="权限" prop="limite">
          <el-select v-model="ruleForm.limite" placeholder="请选择活动区域">
            <el-option label="密保员" value="密保员" />
        ...
        <el-form-item label="确认密码" prop="repassword">
          <el-input v-model="ruleForm.repassword" style="width: 200px;" type="password" />
        </el-form-item>
        <el-form-item label="职责描述" prop="desc">
          <el-input v-model="ruleForm.desc" type="textarea" style="width: 200px;" />
        </el-form-item>
        <el-form-item>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" :loading="loading" @click="sureCommit">确 定</el-button>
      </span>
    </el-dialog>
